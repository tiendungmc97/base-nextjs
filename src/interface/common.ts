...
export const MetaDataMessages: { [key in MetaData]: string } = {
  ...
  [MetaData.PASSWORD_FAIL_TOO_MANY_TIMES]:
    "Password failed more than the specified number of times",
  [MetaData.SEND_OTP_GENERAL_MESSAGE]: "We have sent you the OTP code via %s. Please take a look.",
  [MetaData.PASSWORD_INVALID]:
  ...
  [MetaData.RESET_INSTRUCTIONS_SENT]:
    "If we found an eligible account associated with that email, we've sent password reset instructions to the email address on the account.",
  ...
  [MetaData.PASSWORD_ALREADY_USED]:
